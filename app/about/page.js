...
export default function AboutPage() {
  return (
    <section className="px-6 py-8 md:px-10 md:py-12">
      ...
      <p data-reveal style={{ "--reveal-delay": "130ms" }} className="motion-reveal mt-4 max-w-[760px] text-sm text-[#4c4c4c] md:text-base">
      ...
      <section data-reveal className="motion-reveal mt-8 rounded-2xl border border-[#d9d7ce] bg-white p-5">
        <h2 className="text-2xl font-semibold">Principles</h2>
        <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-3">
          {PRINCIPLES.map((principle) => (
            <article key={principle.title} className="motion-card rounded-xl border border-[#e2e0d8] bg-[#faf9f6] p-4">
      ...
      <section data-reveal className="motion-reveal mt-5 rounded-2xl border border-[#d9d7ce] bg-white p-5">
        ...
        <ul className="mt-4 grid grid-cols-1 gap-2 text-sm text-[#4c4c4c] sm:grid-cols-2 lg:grid-cols-3">
          {CAPABILITIES.map((item) => (
            <li key={item} className="motion-card rounded-lg border border-[#e2e0d8] bg-[#faf9f6] px-3 py-2">
              {item}
            </li>
          ))}
        </ul>
      ...
      <section data-reveal className="motion-reveal mt-5 rounded-2xl border border-[#d9d7ce] bg-white p-5">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
          <article className="motion-card rounded-xl border border-[#e2e0d8] bg-[#faf9f6] p-4">
