// Edit English content, then run `npm run i18n:generate` to regenerate other languages.
...
export const TRANSLATIONS = {
  "en": {
    ...
    "work": {
      ...
      "description": "Each case study explains challenge, approach, deliverables, and measurable outcomes from multidisciplinary execution.",
      "openCase": "Open Case"
    },
    "caseStudy": {
    ...
    "contact": {
      ...
      "description": "Share your product goals, timeline, and current challenges. I can support strategy, design, and implementation end-to-end.",
      "emailTitle": "Email",
